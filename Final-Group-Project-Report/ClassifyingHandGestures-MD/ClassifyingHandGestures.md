...
![Figure 1 — American Sign Language alphabet](./assets/figure1.png)
...
![Figure 2 — Convolutional Neural Network scheme](./assets/figure2.jpeg)
...
![Figure 3 — AlexNet architecture](./assets/figure3.png)
...
![Figure 4 — Comparison of linear convolution layer (left) and NiN layer (right)](./assets/figure4.png)

![Figure 5 — Inception module](./assets/figure5.png)
...
![Figure 6 — Baseline accuracy trends over 20 epochs (left) and loss trends (right)](./assets/figure6.png)
...
![Figure 7 — LeNet loss trends (left) and accuracy trends (right)](./assets/figure7.png)
...
![Figure 8 — Confusion matrix: Baseline (10 epochs)](./assets/figure8.png)

![Figure 9 — Confusion matrix: LeNet (4 epochs)](./assets/figure9.png)
