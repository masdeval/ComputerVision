...
#lenet = torch.load('lenetModelfinal.pkl')
#lenet.eval()
...
# -------------------- Model (Lenet from the original version)
...
# ---- write the model
#writer_train.add_graph(lenet, Variable((torch.Tensor(train_loader.dataset.dataImages)).cpu(), ))
